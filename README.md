...
**Live tool:** [rommelvisuals.github.io/qls-formatter](https://rommelvisuals.github.io/qls-formatter/)
...
1. Export orders from Shopify admin (Orders > Export > CSV)
2. Open the tool at [rommelvisuals.github.io/qls-formatter](https://rommelvisuals.github.io/qls-formatter/)
3. Drop the CSV file onto the upload area
4. Filter by product if needed
5. Fix any rows flagged under "Missing data"
6. Set a filename and click **Download XLSX**
...
Plain HTML, CSS, and vanilla JavaScript. No frameworks, no dependencies except [SheetJS](https://sheetjs.com) (loaded via CDN) for XLSX export.
